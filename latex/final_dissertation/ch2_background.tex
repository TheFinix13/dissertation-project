...
\begin{enumerate}
  \item \textbf{Weak baselines.} Much published work beats only strawman
        ...
        agent may deploy. Section~\ref{sec:res_pilot} shows a live
        example where an unfair baseline would have converted a null
        result into a spurious ten-fold victory.
  ...
  \item \textbf{Ignored transaction costs.} Costless backtests reward
        ...
        --- and Section~\ref{sec:res_fees} shows the value-based agent
        measurably adapting its behaviour to them.
