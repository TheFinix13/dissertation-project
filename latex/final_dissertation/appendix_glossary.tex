...
\begin{description}
  ...
  three: do nothing, buy a \$1{,}000 slice of the asset, or sell one.
  ...
  \item[Training / test split] The data is cut in two by date: the agent
  learns only on the earlier part (2018--Oct 2022) and is examined only
  on the later part (Nov 2022--Dec 2024), which it has never seen ---
  like a mock exam written after the revision period ended.
