...
- Test universe: a 70-ticker diversified-equity universe materialised as the named group `robustness_70` in `experiments/configs/dissertation_protocol.json`, fixed and reproducible. Single-ticker SPY case study is presented separately in Section 5.3 / Section 5.4 as a representative deep-dive before the 70-ticker robustness evidence in Section 5.5.
...
The 70-ticker robustness evidence from Section 5.5 / Appendix B of the academic dissertation can also be presented in a companion document written for a non-quantitative reader, in a register a finance practitioner can read in one sitting.
...
- Reproducible scripts:
  - `experiments/runners/run_baseline.py` (`--tickers robustness_70 --tag robust70` for the 70-ticker run)
